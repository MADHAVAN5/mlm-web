                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $direct_agent_list_query = mysqli_query($conn, "SELECT * FROM `wallet_history` WHERE `agent_id`= '$my_id' AND `desp`!='Level Income' AND `desp`!='Matrix autopool Level Income' AND `desp`!='Referral Income' AND `status`='0' ORDER BY `wallet_history`.`date_time` DESC");
                                    $a = 0;
