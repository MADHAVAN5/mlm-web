            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <!-- totel income Card -->
                        <?php
                            $income_data = mysqli_fetch_array(mysqli_query($conn, "SELECT SUM(amt) income FROM `wallet_history` WHERE `status` = '0'"));
                        ?>
                        <div class="col-xxl-4 col-md-4">
                            <div class="card info-card revenue-card">
                                <div class="card-body">
                        ...
                        <?php
                            $matrix_coungt_data = mysqli_fetch_array(mysqli_query($conn, "SELECT SUM(amt) matrix_income FROM `wallet_history` WHERE `desp` = 'Matrix autopool Level Income'"));
                        ?>
                        <div class="col-xxl-4 col-md-4">
                            <div class="card info-card revenue-card">
                                <div class="card-body">
                                    <h5 class="card-title">Income <span>| autopool</span></h5>
