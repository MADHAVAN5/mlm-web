...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Autopool Income</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Income</li>
                    <li class="breadcrumb-item active">Autopool Income</li>
                </ol>
            </nav>
        </div>
        ...
        <section class="section dashboard">
            ...
            <div class="col-lg-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <h5 class="card-title">Autopool Income</h5>
                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                    <?php
                                    $direct_agent_list_query = mysqli_query($conn, "SELECT * FROM `wallet_history` WHERE `desp`='Matrix autopool Level Income' ORDER BY `wallet_history`.`date_time` DESC");
                                    $a = 0;
